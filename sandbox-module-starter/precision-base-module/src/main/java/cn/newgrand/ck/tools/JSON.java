...
public class JSON {
    ...
    public static String toNullableJSONString(Object value) {
    ...
    public static <T> T parseNullaleObject(String content, TypeReference<T> valueType) {
    ...
    public static <T> T parseObject(String content, TypeReference<T> valueType, Consumer<Exception> onError) {
        if(Objects.isNull(content)){
            return null;
        }
        try {
    ...
    public static Map parseMap(String jsonObject) {
        try {
            return objectMapper.readValue(jsonObject, new TypeReference<Map>() {
            });
